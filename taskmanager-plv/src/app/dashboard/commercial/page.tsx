  ...
  const loadDashboardData = async () => {
    try {
      ...
      const [commandesRes, clientsRes] = await Promise.all([
        supabase.from('commandes').select('statut').eq('commercial_id', user.id),
        supabase.from('clients').select('id').eq('commercial_id', user.id)
      ])
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="text-gray-600">Gestion de vos clients et commandes</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="mb-8">
          <CardHeader>
            <CardTitle>Mes Clients ({stats.mesClients})</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            <div className="text-center py-8 text-gray-500">
              Fonctionnalité de gestion des clients à implémenter
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Dernières commandes que vous gérez
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
