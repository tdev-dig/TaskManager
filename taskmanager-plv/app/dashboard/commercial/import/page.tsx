...
export default function ImportExcelCommercialPage() {
    ...
    try {
      ...
      for (const row of jsonData) {
        try {
          ...
          if (!client) {
            errors.push(`Client non trouvé ou non autorisé: ${row.client_id}`)
            continue
          }
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">Importez vos commandes depuis un fichier Excel</p>
      </div>
            ...
            <div className="space-y-3">
              ...
              <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                <p className="text-sm text-blue-900">
                  <strong>💡 Astuce:</strong> Consultez votre liste de clients pour obtenir les IDs clients.
                </p>
              </div>
            </div>
          </CardContent>
